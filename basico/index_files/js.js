 ...
 let mascara_telefone = phoneMaskGreat['#'+$(campo).closest('.gpc-e').attr('id')+'#'+$(campo).attr('id')];
 let valor_bruto = ($(campo).val() || '').trim();
 if (valor_bruto.charAt(0) === '+'){mascara_telefone.setNumber(valor_bruto);}
 return mascara_telefone.isValidNumber();
}
 ...
 const mascara_telefone = phoneMaskGreat['#'+elemento_envio+'#'+id];
 let numero_telefone = mascara_telefone.getNumber();
 if (!numero_telefone){numero_telefone = `+${mascara_telefone.getSelectedCountryData().dialCode}${$(this).find('.gpc_campo').val()}`;}
 post['campos'][i] ={'id':id, 'titulo':titulo, 'valor':numero_telefone, 'tipo':'telefone'};
}
 ...
 total_campos +=1;
 post['campos'][total_campos] ={'id':'input_uri', 'titulo':'URL', 'valor':window.location.href}; if(typeof window.gpages_experiment_id!=='undefined' && window.gpages_experiment_id){ total_campos +=1; post['campos'][total_campos] ={'id':'input_experiment_id', 'titulo':'Id do experimento', 'valor':window.gpages_experiment_id}; total_campos +=1; post['campos'][total_campos] ={'id':'input_variation_id', 'titulo':'Id da variação', 'valor':window.gpages_variation_id}; }
 ...
 'carregar' :true,
 'externo' :true,
 'url' :'https://n8n.pimm.com.br/webhook-test/form-relojoeiro-basico',
 ...
 let valor = JSON.stringify(post['campos'][index].valor).toLowerCase();
 if ((regex_resultado = regex.exec(valor)) !== null && email == ''){email = await hash(regex_resultado[0]);}
 if (post['campos'][index]?.tipo == 'telefone' && phone == ''){phone = await hash(valor);}
 ...
 if(elemento.find('.gpc_botao').attr('gpc-link') == undefined || elemento.find('.gpc_botao').attr('gpc-link') == ''){$('.aviso_texto').html((elemento.find('.gpc_botao').attr('gpc-mensagem_parabens') != undefined && elemento.find('.gpc_botao').attr('gpc-mensagem_parabens') != '' ? elemento.find('.gpc_botao').attr('gpc-mensagem_parabens') :"Obrigado!!!"));}
 let link_botao = '';
 ...
 GLoading.carregar({'ativar':false});
 if (window.gScrollSet){window.gScrollSet(0, true);}else{window.scroll({top:0, behavior:"smooth"});}
 return false;
}
}
 $(function(){
...
GObserver.iniciar();
 ...
 elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771101370051':{'desktop':53, 'mobile':32.969}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771101477207':{'desktop':281, 'mobile':340}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771101570292':{'desktop':681, 'mobile':1170}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771101657153':{'desktop':53, 'mobile':40}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771101783853':{'desktop':107, 'mobile':209.028}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771101845065':{'desktop':288.899, 'mobile':317.5}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771101900896':{'desktop':107.04, 'mobile':81.5246}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771102079752':{'desktop':107.06, 'mobile':81.5246}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771102198646':{'desktop':260.356, 'mobile':754.741}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771102259399':{'desktop':624.6, 'mobile':727.241}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771102369422':{'desktop':65, 'mobile':37}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771102450328':{'desktop':242, 'mobile':720.99}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771102500261':{'desktop':242, 'mobile':221.879}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771102672906':{'desktop':400.608, 'mobile':414.098}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771102779373':{'desktop':54.651, 'mobile':330.442}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771102842396':{'desktop':177.05, 'mobile':427.298}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771104103219':{'desktop':200, 'mobile':450}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771104356567':{'desktop':200, 'mobile':243}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771104406538':{'desktop':902.72, 'mobile':163}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771104559902':{'desktop':261, 'mobile':272}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771104654044':{'desktop':204, 'mobile':241}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771104763443':{'desktop':749, 'mobile':680}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771104890882':{'desktop':64.4474, 'mobile':40}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771104982473':{'desktop':119.574, 'mobile':80.6831}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771105060179':{'desktop':239, 'mobile':189.057}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771105126880':{'desktop':88.915, 'mobile':92.0946}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771105262882':{'desktop':94.61, 'mobile':93.4651}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771105306915':{'desktop':148.846, 'mobile':60.445}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771105458358':{'desktop':98.0378, 'mobile':115.88}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771105594396':{'desktop':146.15, 'mobile':60.4333}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771105686026':{'desktop':180.795, 'mobile':612.196}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771105791753':{'desktop':162.109, 'mobile':167.009}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771105959179':{'desktop':0.0349, 'mobile':-23.626}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771106008854':{'desktop':136, 'mobile':155}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771106118818':{'desktop':196.037, 'mobile':439}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771106118818_d':{'desktop':196.037, 'mobile':439}, 'e_3634185_1_17871497771106118818_m':{'desktop':196.037, 'mobile':439}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771106247369':{'desktop':633, 'mobile':775}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771106326963':{'desktop':410, 'mobile':676}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771106447091':{'desktop':485, 'mobile':962}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771106570569':{'desktop':351.841, 'mobile':815.168}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771106649390':{'desktop':380.64, 'mobile':1030.31}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771107095520':{'desktop':56, 'mobile':43}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771107196377':{'desktop':167, 'mobile':439}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771107261942':{'desktop':196, 'mobile':743}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771107355903':{'desktop':196, 'mobile':450}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771107429936':{'desktop':261, 'mobile':532}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771107556776':{'desktop':200, 'mobile':496}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_17871497771108195880':{'desktop':873.574, 'mobile':723}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711010135157':{'desktop':167, 'mobile':2990}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711010680129':{'desktop':119.573, 'mobile':467}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711010710102':{'desktop':105.746, 'mobile':406}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711010836701':{'desktop':222.759, 'mobile':512}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711010960644':{'desktop':64.4414, 'mobile':844}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711011021446':{'desktop':327.136, 'mobile':879}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711011162282':{'desktop':417, 'mobile':1004}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711011251904':{'desktop':748.6, 'mobile':1260}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711011387717':{'desktop':858, 'mobile':1362}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711011404609':{'desktop':801, 'mobile':1298}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711011581029':{'desktop':869, 'mobile':1423}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711011671327':{'desktop':276.691, 'mobile':194.419}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711011787207':{'desktop':39.4875, 'mobile':44.4895}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711011841541':{'desktop':95.913, 'mobile':93.464}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711011967612':{'desktop':254.6, 'mobile':740.99}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711012040865':{'desktop':167.607, 'mobile':632.196}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711013320021':{'desktop':112.222, 'mobile':420}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711014183242':{'desktop':973, 'mobile':1564}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711014209524':{'desktop':510, 'mobile':1565}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711014373699':{'desktop':541, 'mobile':2478}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711014433682':{'desktop':541, 'mobile':2478}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711014595265':{'desktop':541, 'mobile':1015}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711014675263':{'desktop':541, 'mobile':1015}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711014764106':{'desktop':546, 'mobile':1067}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711014839866':{'desktop':605, 'mobile':1113}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178714977711015099454':{'desktop':964.573, 'mobile':990}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715576431225065':{'desktop':541, 'mobile':792}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715576431243464':{'desktop':537, 'mobile':743}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715576431280812':{'desktop':594, 'mobile':824}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715576431275833':{'desktop':510, 'mobile':2235.55}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715580617558945':{'desktop':537, 'mobile':183}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715654656431092':{'desktop':1250, 'mobile':680}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715654656424850':{'desktop':1249, 'mobile':1693}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715654656445605':{'desktop':1293, 'mobile':1735}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715654656401062':{'desktop':1414, 'mobile':1828}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715654656416956':{'desktop':1571, 'mobile':1961}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715654656509966':{'desktop':112.222, 'mobile':420}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715695025826829':{'desktop':699, 'mobile':1193}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715695025820384':{'desktop':112.222, 'mobile':420}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715697502746870':{'desktop':1011, 'mobile':1297}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715697502746870_d':{'desktop':1011, 'mobile':1297}, 'e_3634185_1_178715697502746870_m':{'desktop':1011, 'mobile':1297}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178715697502870408':{'desktop':112.222, 'mobile':420}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178716290128036258':{'desktop':559, 'mobile':183}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178716319358573575':{'desktop':882, 'mobile':1489}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178716319358573575_d':{'desktop':882, 'mobile':1489}, 'e_3634185_1_178716319358573575_m':{'desktop':882, 'mobile':1489}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178716319358693578':{'desktop':112.222, 'mobile':420}});elementos_posicao = Object.assign(elementos_posicao,{'e_3634185_1_178716334598362318':{'desktop':1480, 'mobile':1732}});blocos_posicao = Object.assign(blocos_posicao,{'b_3634185_1_1787149777110138554':{'desktop':884, 'mobile':1270}});blocos_posicao = Object.assign(blocos_posicao,{'e_3634185_1_17871497771101570292':{'desktop':566, 'mobile':682.486}});blocos_posicao = Object.assign(blocos_posicao,{'e_3634185_1_178715654656416956':{'desktop':566, 'mobile':682.486}});blocos_posicao = Object.assign(blocos_posicao,{'e_3634185_1_178715695025826829':{'desktop':566, 'mobile':682.486}});blocos_posicao = Object.assign(blocos_posicao,{'e_3634185_1_178715697502746870':{'desktop':566, 'mobile':682.486}});blocos_posicao = Object.assign(blocos_posicao,{'e_3634185_1_178715697502746870_d':{'desktop':566, 'mobile':682.486}});blocos_posicao = Object.assign(blocos_posicao,{'e_3634185_1_178715697502746870_m':{'desktop':566, 'mobile':682.486}});blocos_posicao = Object.assign(blocos_posicao,{'e_3634185_1_178716319358573575':{'desktop':566, 'mobile':682.486}});blocos_posicao = Object.assign(blocos_posicao,{'e_3634185_1_178716319358573575_d':{'desktop':566, 'mobile':682.486}});blocos_posicao = Object.assign(blocos_posicao,{'e_3634185_1_178716319358573575_m':{'desktop':566, 'mobile':682.486}});blocos_posicao = Object.assign(blocos_posicao,{'b_3634185_1_1787149777110298794':{'desktop':704, 'mobile':1034.14}});blocos_posicao = Object.assign(blocos_posicao,{'b_3634185_1_1787149777110317611':{'desktop':657, 'mobile':1284.75}});blocos_posicao = Object.assign(blocos_posicao,{'b_3634185_1_1787149777110483106':{'desktop':815, 'mobile':1330.47}});blocos_posicao = Object.assign(blocos_posicao,{'b_3634185_1_1787149777110536385':{'desktop':1001, 'mobile':1413}});blocos_posicao = Object.assign(blocos_posicao,{'b_3634185_1_1787149777110691369':{'desktop':1769, 'mobile':2091}});blocos_posicao = Object.assign(blocos_posicao,{'b_3634185_1_1787149777110707462':{'desktop':330.901, 'mobile':278.92}});var gPopupEstilos=typeof gPopupEstilos!=='undefined'?gPopupEstilos:function(d,m){var p=function(){return window.matchMedia&&window.matchMedia('(max-width:800px)').matches?m:d;};return{get desktop(){return p();},get mobile(){return p();}};};var elementos_popup=Object.assign(typeof elementos_popup!=='undefined'?elementos_popup:{},{"e_3634185_1_17871497771101570292":{conteudo:"<div id=\"e_3634185_1_178714977711013320021\" class=\"element gpc-blocos_bloco_elemento elemento_formulario gpc-e e_formulario e_3634185_1_178714977711013320021 gpr25\"><form class=\"conteudo elemento_formulario c e_formulario gpr26\"><fieldset class=\"gpr27\"><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr28\"><div class=\"gpc_campos-titulo esconder gpr29\"><label class=\"gpr30\" for=\"input_3634185_1_178714977711013320021-nome\"><span>Nome<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"input_3634185_1_178714977711013320021-nome\" class=\"gpc_campo borda_igual gpr31\" name=\"nome\" type=\"text\" value=\"\" placeholder=\"Nome\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr32\"><\/div><\/div><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr33\"><div class=\"gpc_campos-titulo esconder gpr34\"><label class=\"gpr35\" for=\"input_1756920652\"><span><em>*<\/em>Whatsapp<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"input_1756920652\" class=\"gpc_campo telefone obrigatorio borda_igual gpr36\" name=\"whatsapp\" type=\"tel\" value=\"\" placeholder=\"*Whatsapp\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr37\"><\/div><\/div><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr38\"><div class=\"gpc_campos-titulo esconder gpr39\"><label class=\"gpr40\" for=\"input_3634185_1_1787149777110133200211-e-mail\"><span><em>*<\/em>E-mail<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"input_3634185_1_1787149777110133200211-e-mail\" class=\"gpc_campo email obrigatorio borda_igual gpr41\" name=\"e-mail\" type=\"email\" value=\"\" placeholder=\"*E-mail\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr42\"><\/div><\/div><div class=\"gpc_campos gpc_campos-consentimento_lgpd gpc_campos-100 gpr43\"><div class=\"gpc_campos-titulo esconder gpr44\"><label class=\"gpr45\" for=\"input_3634185_1_1787149777110133200212-politicas-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios\"><span><em>*<\/em>Políticas de privacidade<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><div class=\"gpc_campos-campo-opcao obrigatorio gpr46\"><input id=\"input_3634185_1_1787149777110133200212-politicas-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios-polticas-de-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios\" type=\"checkbox\" name=\"polticas-de-privacidade\" value=\"Concordo em fornecer meus dados para receber conteúdos e ofertas por e-mail ou outros meios.\"><label for=\"input_3634185_1_1787149777110133200212-politicas-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios-polticas-de-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios\">Concordo em fornecer meus dados para receber conteúdos e ofertas por e-mail ou outros meios.<\/label><\/div><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr47\"><\/div><\/div><\/fieldset><div class=\"gpc_botao borda_igual elemento_formulario typography-custom-4 e_formulario gpr48\" gpc-mensagem_parabens=\"Enviado com sucesso!\" gpc-link=\"https://pay.kiwify.com.br/irH0JfL\"><span class=\"gpr49\">Enviar agora mesmo<\/span><\/div><\/form><\/div>",estilos:gPopupEstilos("box-sizing:border-box;width:480px;height:566px;max-width:480px","box-sizing:border-box;width:340px;height:682.486px;max-width:340px")},"e_3634185_1_178715654656416956":{conteudo:"<div id=\"e_3634185_1_178715654656509966\" class=\"element gpc-blocos_bloco_elemento elemento_formulario gpc-e e_formulario e_3634185_1_178715654656509966 gpr50\"><form class=\"conteudo elemento_formulario c e_formulario gpr51\"><fieldset class=\"gpr52\"><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr53\"><div class=\"gpc_campos-titulo esconder gpr54\"><label class=\"gpr55\" for=\"form_3634185_1_178715654656509966_1\"><span>Nome<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"form_3634185_1_178715654656509966_1\" class=\"gpc_campo borda_igual gpr56\" name=\"nome\" type=\"text\" value=\"\" placeholder=\"Nome\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr57\"><\/div><\/div><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr58\"><div class=\"gpc_campos-titulo esconder gpr59\"><label class=\"gpr60\" for=\"form_3634185_1_178715654656509966_2\"><span><em>*<\/em>Whatsapp<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"form_3634185_1_178715654656509966_2\" class=\"gpc_campo telefone obrigatorio borda_igual gpr61\" name=\"whatsapp\" type=\"tel\" value=\"\" placeholder=\"*Whatsapp\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr62\"><\/div><\/div><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr63\"><div class=\"gpc_campos-titulo esconder gpr64\"><label class=\"gpr65\" for=\"form_3634185_1_178715654656509966_3\"><span><em>*<\/em>E-mail<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"form_3634185_1_178715654656509966_3\" class=\"gpc_campo email obrigatorio borda_igual gpr66\" name=\"e-mail\" type=\"email\" value=\"\" placeholder=\"*E-mail\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr67\"><\/div><\/div><div class=\"gpc_campos gpc_campos-consentimento_lgpd gpc_campos-100 gpr68\"><div class=\"gpc_campos-titulo esconder gpr69\"><label class=\"gpr70\" for=\"form_3634185_1_178715654656509966_4\"><span><em>*<\/em>Políticas de privacidade<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><div class=\"gpc_campos-campo-opcao obrigatorio gpr71\"><input id=\"input_3634185_1_1787149777110133200212-politicas-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios-polticas-de-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios\" type=\"checkbox\" name=\"polticas-de-privacidade\" value=\"Concordo em fornecer meus dados para receber conteúdos e ofertas por e-mail ou outros meios.\"><label for=\"input_3634185_1_1787149777110133200212-politicas-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios-polticas-de-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios\">Concordo em fornecer meus dados para receber conteúdos e ofertas por e-mail ou outros meios.<\/label><\/div><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr72\"><\/div><\/div><\/fieldset><div class=\"gpc_botao borda_igual elemento_formulario typography-custom-4 e_formulario gpr73\" gpc-mensagem_parabens=\"Enviado com sucesso!\" gpc-link=\"https://cursos.relojoeirovictor.com.br/relojoeiro-profissional\"><span class=\"gpr74\">Enviar agora mesmo<\/span><\/div><\/form><\/div>",estilos:gPopupEstilos("box-sizing:border-box;width:480px;height:566px;max-width:480px","box-sizing:border-box;width:340px;height:682.486px;max-width:340px")},"e_3634185_1_178715695025826829":{conteudo:"<div id=\"e_3634185_1_178715695025820384\" class=\"element gpc-blocos_bloco_elemento elemento_formulario gpc-e e_formulario e_3634185_1_178715695025820384 gpr75\"><form class=\"conteudo elemento_formulario c e_formulario gpr76\"><fieldset class=\"gpr77\"><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr78\"><div class=\"gpc_campos-titulo esconder gpr79\"><label class=\"gpr80\" for=\"form_3634185_1_178715695025820384_1\"><span>Nome<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"form_3634185_1_178715695025820384_1\" class=\"gpc_campo borda_igual gpr81\" name=\"nome\" type=\"text\" value=\"\" placeholder=\"Nome\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr82\"><\/div><\/div><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr83\"><div class=\"gpc_campos-titulo esconder gpr84\"><label class=\"gpr85\" for=\"form_3634185_1_178715695025820384_2\"><span><em>*<\/em>Whatsapp<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"form_3634185_1_178715695025820384_2\" class=\"gpc_campo telefone obrigatorio borda_igual gpr86\" name=\"whatsapp\" type=\"tel\" value=\"\" placeholder=\"*Whatsapp\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr87\"><\/div><\/div><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr88\"><div class=\"gpc_campos-titulo esconder gpr89\"><label class=\"gpr90\" for=\"form_3634185_1_178715695025820384_3\"><span><em>*<\/em>E-mail<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"form_3634185_1_178715695025820384_3\" class=\"gpc_campo email obrigatorio borda_igual gpr91\" name=\"e-mail\" type=\"email\" value=\"\" placeholder=\"*E-mail\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr92\"><\/div><\/div><div class=\"gpc_campos gpc_campos-consentimento_lgpd gpc_campos-100 gpr93\"><div class=\"gpc_campos-titulo esconder gpr94\"><label class=\"gpr95\" for=\"form_3634185_1_178715695025820384_4\"><span><em>*<\/em>Políticas de privacidade<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><div class=\"gpc_campos-campo-opcao obrigatorio gpr96\"><input id=\"input_3634185_1_1787149777110133200212-politicas-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios-polticas-de-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios\" type=\"checkbox\" name=\"polticas-de-privacidade\" value=\"Concordo em fornecer meus dados para receber conteúdos e ofertas por e-mail ou outros meios.\"><label for=\"input_3634185_1_1787149777110133200212-politicas-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios-polticas-de-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios\">Concordo em fornecer meus dados para receber conteúdos e ofertas por e-mail ou outros meios.<\/label><\/div><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr97\"><\/div><\/div><\/fieldset><div class=\"gpc_botao borda_igual elemento_formulario typography-custom-4 e_formulario gpr98\" gpc-mensagem_parabens=\"Enviado com sucesso!\" gpc-link=\"https://pay.kiwify.com.br/irH0JfL\"><span class=\"gpr99\">Enviar agora mesmo<\/span><\/div><\/form><\/div>",estilos:gPopupEstilos("box-sizing:border-box;width:480px;height:566px;max-width:480px","box-sizing:border-box;width:340px;height:682.486px;max-width:340px")},"e_3634185_1_178715697502746870":{conteudo:"<div id=\"e_3634185_1_178715697502870408\" class=\"element gpc-blocos_bloco_elemento elemento_formulario gpc-e e_formulario e_3634185_1_178715697502870408 gpr100\"><form class=\"conteudo elemento_formulario c e_formulario gpr101\"><fieldset class=\"gpr102\"><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr103\"><div class=\"gpc_campos-titulo esconder gpr104\"><label class=\"gpr105\" for=\"form_3634185_1_178715697502870408_1\"><span>Nome<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"form_3634185_1_178715697502870408_1\" class=\"gpc_campo borda_igual gpr106\" name=\"nome\" type=\"text\" value=\"\" placeholder=\"Nome\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr107\"><\/div><\/div><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr108\"><div class=\"gpc_campos-titulo esconder gpr109\"><label class=\"gpr110\" for=\"form_3634185_1_178715697502870408_2\"><span><em>*<\/em>Whatsapp<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"form_3634185_1_178715697502870408_2\" class=\"gpc_campo telefone obrigatorio borda_igual gpr111\" name=\"whatsapp\" type=\"tel\" value=\"\" placeholder=\"*Whatsapp\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr112\"><\/div><\/div><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr113\"><div class=\"gpc_campos-titulo esconder gpr114\"><label class=\"gpr115\" for=\"form_3634185_1_178715697502870408_3\"><span><em>*<\/em>E-mail<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"form_3634185_1_178715697502870408_3\" class=\"gpc_campo email obrigatorio borda_igual gpr116\" name=\"e-mail\" type=\"email\" value=\"\" placeholder=\"*E-mail\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr117\"><\/div><\/div><div class=\"gpc_campos gpc_campos-consentimento_lgpd gpc_campos-100 gpr118\"><div class=\"gpc_campos-titulo esconder gpr119\"><label class=\"gpr120\" for=\"form_3634185_1_178715697502870408_4\"><span><em>*<\/em>Políticas de privacidade<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><div class=\"gpc_campos-campo-opcao obrigatorio gpr121\"><input id=\"input_3634185_1_1787149777110133200212-politicas-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios-polticas-de-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios\" type=\"checkbox\" name=\"polticas-de-privacidade\" value=\"Concordo em fornecer meus dados para receber conteúdos e ofertas por e-mail ou outros meios.\"><label for=\"input_3634185_1_1787149777110133200212-politicas-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios-polticas-de-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios\">Concordo em fornecer meus dados para receber conteúdos e ofertas por e-mail ou outros meios.<\/label><\/div><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr122\"><\/div><\/div><\/fieldset><div class=\"gpc_botao borda_igual elemento_formulario typography-custom-4 e_formulario gpr123\" gpc-mensagem_parabens=\"Enviado com sucesso!\" gpc-link=\"https://pay.kiwify.com.br/irH0JfL\"><span class=\"gpr124\">Enviar agora mesmo<\/span><\/div><\/form><\/div>",estilos:gPopupEstilos("box-sizing:border-box;width:480px;height:566px;max-width:480px","box-sizing:border-box;width:340px;height:682.486px;max-width:340px")},"e_3634185_1_178716319358573575":{conteudo:"<div id=\"e_3634185_1_178716319358693578\" class=\"element gpc-blocos_bloco_elemento elemento_formulario gpc-e e_formulario e_3634185_1_178716319358693578 gpr125\"><form class=\"conteudo elemento_formulario c e_formulario gpr126\"><fieldset class=\"gpr127\"><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr128\"><div class=\"gpc_campos-titulo esconder gpr129\"><label class=\"gpr130\" for=\"form_3634185_1_178716319358693578_1\"><span>Nome<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"form_3634185_1_178716319358693578_1\" class=\"gpc_campo borda_igual gpr131\" name=\"nome\" type=\"text\" value=\"\" placeholder=\"Nome\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr132\"><\/div><\/div><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr133\"><div class=\"gpc_campos-titulo esconder gpr134\"><label class=\"gpr135\" for=\"form_3634185_1_178716319358693578_2\"><span><em>*<\/em>Whatsapp<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"form_3634185_1_178716319358693578_2\" class=\"gpc_campo telefone obrigatorio borda_igual gpr136\" name=\"whatsapp\" type=\"tel\" value=\"\" placeholder=\"*Whatsapp\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr137\"><\/div><\/div><div class=\"gpc_campos gpc_campos-input gpc_campos-100 gpr138\"><div class=\"gpc_campos-titulo esconder gpr139\"><label class=\"gpr140\" for=\"form_3634185_1_178716319358693578_3\"><span><em>*<\/em>E-mail<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><input id=\"form_3634185_1_178716319358693578_3\" class=\"gpc_campo email obrigatorio borda_igual gpr141\" name=\"e-mail\" type=\"email\" value=\"\" placeholder=\"*E-mail\"><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr142\"><\/div><\/div><div class=\"gpc_campos gpc_campos-consentimento_lgpd gpc_campos-100 gpr143\"><div class=\"gpc_campos-titulo esconder gpr144\"><label class=\"gpr145\" for=\"form_3634185_1_178716319358693578_4\"><span><em>*<\/em>Políticas de privacidade<\/span><span class=\"gpc_campos-titulo_descricao icone-informacao gtt-baixo esconder\" data-gtt=\"\"><\/span><\/label><\/div><div class=\"gpc_campos-campo\"><div class=\"gpc_campos-campo-opcao obrigatorio gpr146\"><input id=\"input_3634185_1_1787149777110133200212-politicas-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios-polticas-de-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios\" type=\"checkbox\" name=\"polticas-de-privacidade\" value=\"Concordo em fornecer meus dados para receber conteúdos e ofertas por e-mail ou outros meios.\"><label for=\"input_3634185_1_1787149777110133200212-politicas-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios-polticas-de-privacidade-concordo-em-fornecer-meus-dados-para-receber-contedos-e-ofertas-por-e-mail-ou-outros-meios\">Concordo em fornecer meus dados para receber conteúdos e ofertas por e-mail ou outros meios.<\/label><\/div><div class=\"gpc_campos-erro icone_bold-aviso gtt-esquerda\" data-gtt=\"\"><\/div><\/div><div class=\"gpc_campos-texto gpr147\"><\/div><\/div><\/fieldset><div class=\"gpc_botao borda_igual elemento_formulario typography-custom-4 e_formulario gpr148\" gpc-mensagem_parabens=\"Enviado com sucesso!\" gpc-link=\"https://pay.kiwify.com.br/irH0JfL\"><span class=\"gpr149\">Enviar agora mesmo<\/span><\/div><\/form><\/div>",estilos:gPopupEstilos("box-sizing:border-box;width:480px;height:566px;max-width:480px","box-sizing:border-box;width:340px;height:682.486px;max-width:340px")}});elementos_popup["e_3634185_1_178715697502746870_d"]=elementos_popup["e_3634185_1_178715697502746870"];elementos_popup["e_3634185_1_178715697502746870_m"]=elementos_popup["e_3634185_1_178715697502746870"];elementos_popup["e_3634185_1_178716319358573575_d"]=elementos_popup["e_3634185_1_178716319358573575"];elementos_popup["e_3634185_1_178716319358573575_m"]=elementos_popup["e_3634185_1_178716319358573575"];function EnviarConversaoClique(botao){
 try{
 if(botao.hasClass('gpc_botao') && botao.closest('.elemento_formulario').length){return;}
 var elemento = botao.closest('.'+pagina_controle['classe_elemento']);
 if(!elemento.length){elemento = botao.closest('.'+pagina_controle['classe_elemento_antigo']);}
 var id_elemento = elemento.attr('id');
 if(id_elemento == undefined || id_elemento == ''){return;}
 var lista = elemento.filter('.botao_conversao,.gpc-conversion').get().concat(elemento.find('.botao_conversao,.gpc-conversion').get());
 var alvo_conv = botao.attr('href') || '';
 var chave = 'gpc_conv_'+id_elemento+':'+(alvo_conv !== '' ? alvo_conv :lista.indexOf(botao[0]));
 var tipo_elemento = 'Elemento';
 if(botao.hasClass('imagem')){
 tipo_elemento = 'Slider';
 var no_slide = botao[0];var pos_slide = 0;
 var irmao = no_slide.parentNode ? no_slide.parentNode.firstElementChild :null;
 while(irmao){
 var cls_irmao = ' '+(irmao.className || '')+' ';
 if(cls_irmao.indexOf(' imagem ') > -1 && cls_irmao.indexOf(' gsi_clone ') < 0){
 pos_slide++;
 if(irmao === no_slide){tipo_elemento = 'Slider (imagem '+pos_slide+')';break;}
}
 irmao = irmao.nextElementSibling;
}
}else{
 var tipos ={'elemento_botao':'Botão','elemento_imagem':'Imagem','elemento_icone':'Ícone','elemento_titulo':'Título','elemento_texto':'Texto','elemento_slider':'Slider'};
 var no_wrapper = elemento[0];
 for(var classe_tipo in tipos){
 if(elemento.hasClass(classe_tipo) || (no_wrapper && no_wrapper.querySelector('.'+classe_tipo))){tipo_elemento = tipos[classe_tipo];break;}
}
}
 var agora_conv = (new Date()).getTime();
 try{if(window.sessionStorage && (agora_conv - parseInt(sessionStorage.getItem(chave) || '0', 10)) < 3000){return;}}catch(e){}
 var random = Math.random().toString();
 var eid = 'GPages.'+random.substr(random.length-4)+(new Date()).getTime();
 var campos ={};
 var total = 0;
 campos[total] ={'id':'input_referral_source','titulo':'Referral source','valor':(document.referrer == '' ? 'Acesso direto' :document.referrer)};total++;
 campos[total] ={'id':'input_mobile','titulo':'Dispositivo','valor':(Mobile() ? 'Mobile' :'Desktop')};total++;
 campos[total] ={'id':'input_uri','titulo':'URL','valor':window.location.href};total++;
 campos[total] ={'id':'input_id_botao','titulo':'Id do botão','valor':id_elemento};total++;
 campos[total] ={'id':'input_texto_botao','titulo':'Texto do botão','valor':(botao.text() || '').trim().substring(0,120)};total++;
 campos[total] ={'id':'input_tipo_elemento','titulo':'Tipo do elemento','valor':tipo_elemento};total++;
 campos[total] ={'id':'input_link_url','titulo':'Link do botão','valor':(botao.attr('href') || '')};total++;
 if(typeof window.gpages_experiment_id !== 'undefined' && window.gpages_experiment_id){
 campos[total] ={'id':'input_experiment_id','titulo':'Id do experimento','valor':window.gpages_experiment_id};total++;
 campos[total] ={'id':'input_variation_id','titulo':'Id da variação','valor':window.gpages_variation_id};total++;
}
 var post ={'elemento':id_elemento,'tipo':'click','page_id':3634185,'variation_id':(typeof window.gpages_variation_id!=='undefined'&&window.gpages_variation_id?Number(window.gpages_variation_id):null),'campos':campos,'eid':eid,'enav':(typeof c == 'undefined' ? '' :c),'eclid':(typeof fbclid == 'undefined' ? '' :fbclid),'euser':(typeof u == 'undefined' ? '' :u)};
 var corpo = JSON.stringify(post);
 var enviado = false;
 try{if(navigator.sendBeacon){enviado = navigator.sendBeacon('/conversion', new Blob([corpo],{type:'application/json'}));}}catch(e){}
 if(!enviado){AdicionarFilaGQA({'verbo':'POST','uri':corpo,'timeout':10000,'prioridade':'alta','carregar':false,'externo':true,'url':'/conversion'});}
 try{if(window.sessionStorage){sessionStorage.setItem(chave, String(agora_conv));}}catch(e){}
 var email = (typeof gpages_conversion == 'object' && gpages_conversion.em) ? gpages_conversion.em :'';
 var phone = (typeof gpages_conversion == 'object' && gpages_conversion.ph) ? gpages_conversion.ph :'';
}catch(e){console.error('Erro conversao clique:',e);}
}
$(function(){
 $('body').on('click','.botao_conversao,.gpc-conversion',function(e){
 if($(e.target).closest('.botao_conversao,.gpc-conversion')[0] !== this){return;}
 EnviarConversaoClique($(this));
});
});
function InserirScriptsInline(){if(!window.getCrawler()){}}var scripts_estatisticas ={}, scripts_marketing ={};
